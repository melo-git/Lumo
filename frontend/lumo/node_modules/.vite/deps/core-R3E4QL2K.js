...
import "./chunk-O2CRFT6A.js";
import "./chunk-KJBT2OT3.js";
import "./chunk-7WFAVJKE.js";
import {
  HashMD
} from "./chunk-SLG3Z4XN.js";
import {
  LruMap,
  checksumAddress,
  defineFormatter,
  ...
  toHex as toHex2
} from "./chunk-Q57CJT6X.js";
import {
  rotl,
  wrapConstructor
} from "./chunk-VPWVES4S.js";
import "./chunk-ULHGNRDO.js";
import {
  A,
  C,
  E,
...
async function recoverPublicKey({ hash, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-KR33FYF7.js");
  const signature_ = (() => {
...
// node_modules/@reown/appkit/node_modules/uint8arrays/esm/src/index.js
init_shim();

// node_modules/@reown/appkit/node_modules/uint8arrays/esm/src/compare.js
init_shim();
...
// node_modules/@reown/appkit/node_modules/uint8arrays/esm/src/equals.js
init_shim();
...
// node_modules/@reown/appkit/node_modules/uint8arrays/esm/src/xor.js
init_shim();
...
function Ii() {
  return typeof import_process.default < "u" && import_process.default.env.IS_VITEST === "true";
}
function zn() {
...
function Yn(t, e = false) {
  const n2 = import_buffer.Buffer.from(t).toString("base64");
  return e ? n2.replace(/[=]/g, "") : n2;
}
function je(t) {
  return import_buffer.Buffer.from(t, "base64").toString("utf-8");
}
function Ni(t) {
...
${t.length}`, n2 = new TextEncoder().encode(e + t);
  return "0x" + import_buffer.Buffer.from(Gi(n2)).toString("hex");
}
...
function Ji(t) {
  ...
  const i3 = import_buffer.Buffer.from(t, "base64").slice(1, 65);
...
function mr(t) {
  return import_buffer.Buffer.from(JSON.stringify(t)).toString("base64");
}
function wr(t) {
  return JSON.parse(import_buffer.Buffer.from(t, "base64").toString("utf-8"));
}
function at(t) {
...
function io(t) {
  const e = import_buffer.Buffer.from(t.x, "base64"), n2 = import_buffer.Buffer.from(t.y, "base64");
  return concat3([new Uint8Array([4]), e, n2]);
}
function zc(t, e) {
  const [n2, r2, o2] = t.split("."), i3 = import_buffer.Buffer.from(ro(o2), "base64");
...
function ye2(r2, e, t, i3) {
  ...
  try {
    switch (s) {
      ...
      case Po3:
      case So2: {
        if (typeof import_buffer.Buffer < "u" && import_buffer.Buffer.isBuffer(r2) !== import_buffer.Buffer.isBuffer(e) || r2.length !== e.length) return false;
...
var Te = class _Te extends h2 {
  ...
  isGlobalCoreDisabled() {
    try {
      return typeof import_process.default < "u" && import_process.default.env.DISABLE_GLOBAL_CORE === "true";
    } catch {
      return true;
    }
  }
...
function $3(s, t, e, i3 = /* @__PURE__ */ new Map(), n2 = void 0) {
  ...
  if (typeof import_buffer.Buffer < "u" && import_buffer.Buffer.isBuffer(s)) return s.subarray();
  if (W2(s)) {
...
function F3(s, t, e, i3) {
  ...
  for (let a2 = 0; a2 < n2.length; a2++) {
    const r2 = n2[a2];
    let c3 = t[r2], o2 = s[r2];
    if (dt3(c3) && (c3 = { ...c3 }), dt3(o2) && (o2 = { ...o2 }), typeof import_buffer.Buffer < "u" && import_buffer.Buffer.isBuffer(c3) && (c3 = pt3(c3)), Array.isArray(c3)) if (typeof o2 == "object" && o2 != null) {
...
var AppKit = class extends AppKitBaseClient {
  ...
  async injectModalUi() {
    if (!isInitialized && CoreHelperUtil.isClient()) {
      await import("./basic-3GG7HOUD.js");
      await import("./w3m-modal-74TWXJ5I.js");
...
*/
//# sourceMappingURL=core-R3E4QL2K.js.map
