...
var sha2564 = createHasher3(() => new SHA256());
...
function sha2566(value, options = {}) {
  const { as = typeof value === "string" ? "Hex" : "Bytes" } = options;
  const bytes = sha2565(from6(value));
  if (as === "Bytes")
    return bytes;
  return fromBytes2(bytes);
}
...
var InvalidAddressError2 = class extends BaseError4 {
...
function fromDerHex(signature) {
  const { r: r2, s } = secp256k1.Signature.fromDER(from5(signature).slice(2));
  return { r: r2, s };
}
...
function pointG2ToBytes(_c, point, isComp) {
  ...
  if (isComp) {
    ...
    const flag = Boolean(y2.c1 === _0n4 ? y2.c0 * _2n4 / P : y2.c1 * _2n4 / P);
...
function pointG2FromBytes(bytes) {
  ...
  if (value.length === 96 && compressed) {
    ...
    const Y_bit = y2.c1 === _0n4 ? y2.c0 * _2n4 / P : y2.c1 * _2n4 / P ? _1n4 : _0n4;
...
var p2563 = createCurve2({ ...p256_CURVE, Fp: Fp2562, lowS: false }, sha2562);
var p256_hasher2 = (() => {
...
var p3842 = createCurve2({ ...p384_CURVE, Fp: Fp3842, lowS: false }, sha3842);
var p384_hasher2 = (() => {
...
var p5212 = createCurve2({ ...p521_CURVE, Fp: Fp5212, lowS: false, allowedPrivateKeyLengths: [130, 131, 132] }, sha5122);
var p521_hasher2 = (() => {
...
function verify2(options) {
  ...
  return secp256r13.verify(signature, payload instanceof Uint8Array ? payload : fromHex4(payload), toHex4(publicKey).substring(2), ...hash2 ? [{ prehash: true, lowS: true }] : []);
}
...
function parseAsn1Signature2(bytes) {
  ...
  const r2 = BigInt(fromBytes2(bytes.slice(r_start, r_end)));
...
function getAuthenticatorData(options = {}) {
  ...
  const rpIdHash = sha2566(fromString3(rpId));
...
function getClientDataJSON(options) {
  ...
  return JSON.stringify({
    type: "webauthn.get",
    challenge: fromHex8(challenge, { url: true, pad: false }),
    origin,
    crossOrigin,
    ...extraClientData
  });
...
function getSignPayload3(options) {
  ...
  const clientDataJSONHash = sha2566(fromString3(clientDataJSON));
...
function verify3(options) {
  ...
  if (fromBytes2(toBytes6(challenge_extracted)) !== challenge)
    return false;
  const clientDataJSONHash = sha2566(fromString4(clientDataJSON), {
    as: "Bytes"
  });
...
var CredentialCreationFailedError2 = class extends BaseError4 {
  constructor({ cause } = {}) {
...
function toWebAuthnSignature({ webauthn, signature }) {
  const { r: r2, s } = fromHex6(signature);
  return encodeAbiParameters([
    {
      components: [
        {
...
*/
//# sourceMappingURL=dist-OANOREQG.js.map
