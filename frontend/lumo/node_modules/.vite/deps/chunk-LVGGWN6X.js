...
var ICONS = {
  add: async () => (await import("./add-KT6AIZKU.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-FZSXDGU6.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-NVZLM3ZN.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-SFZDKKXJ.js")).appStoreSvg,
  apple: async () => (await import("./apple-PECPO67L.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-SPY2QGXJ.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-BUVHBHLY.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-GJD6NO6Y.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-YQYKSOOS.js")).arrowTopSvg,
  bank: async () => (await import("./bank-322JWVBG.js")).bankSvg,
  browser: async () => (await import("./browser-KM54YRQV.js")).browserSvg,
  card: async () => (await import("./card-ILXOVWGP.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-MTEIC2RX.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-6QLHTUQN.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-PZAERZHL.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-MLYZ4M3V.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-IMVCUX67.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-ZNXZABUO.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-64Z7SG4Z.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-LAQACQEZ.js")).clockSvg,
  close: async () => (await import("./close-RGOHHIOR.js")).closeSvg,
  compass: async () => (await import("./compass-7GIPW2XD.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-ARA4XHFS.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-PO4PXEJM.js")).copySvg,
  cursor: async () => (await import("./cursor-OVJFTJOV.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-LOTHBXEB.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-U3WDDPAI.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-H7YRDREG.js")).disconnectSvg,
  discord: async () => (await import("./discord-YDBXQRAE.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-ZC3LUOWL.js")).etherscanSvg,
  extension: async () => (await import("./extension-IF6QQXFF.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-RWO6C6TM.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-RAMCFFUS.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-OOC46JLA.js")).farcasterSvg,
  filters: async () => (await import("./filters-DQUYBOS6.js")).filtersSvg,
  github: async () => (await import("./github-OCEFZDI6.js")).githubSvg,
  google: async () => (await import("./google-VPXBTRJI.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-AQ5ZYKCY.js")).helpCircleSvg,
  image: async () => (await import("./image-ZYJJ3ZSL.js")).imageSvg,
  id: async () => (await import("./id-XLTZPRKI.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-KJSYIHOB.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-4KNIC53L.js")).lightbulbSvg,
  mail: async () => (await import("./mail-NTH6GQBR.js")).mailSvg,
  mobile: async () => (await import("./mobile-HGELF34V.js")).mobileSvg,
  more: async () => (await import("./more-HZXALWDH.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-EU54FC6P.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-NNUMJNHA.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-6WFMBQ3U.js")).offSvg,
  playStore: async () => (await import("./play-store-6Y3D55I4.js")).playStoreSvg,
  plus: async () => (await import("./plus-4IN2LP5Y.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-SNE7OTMA.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-KPT35XVS.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-2ZW7LFXH.js")).refreshSvg,
  search: async () => (await import("./search-ZUYYE2V4.js")).searchSvg,
  send: async () => (await import("./send-DUD3X6XB.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-7OAZCF7E.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-554KNSQS.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-2KRP7B2K.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-BH4KH5GK.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-O7Z5QFS3.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-PYGFYOP2.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-AFEUXBKD.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-JO5Z2UYD.js")).twitchSvg,
  twitter: async () => (await import("./x-X56UVXSK.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-GQZJ4VE7.js")).twitterIconSvg,
  verify: async () => (await import("./verify-YVR6BNHW.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-7JSVAU6G.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-I7JCU33U.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-EDWBIDJA.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-EDWBIDJA.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-EDWBIDJA.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-MPCOKW4A.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-E7OS6Q2A.js")).warningCircleSvg,
  x: async () => (await import("./x-X56UVXSK.js")).xSvg,
  info: async () => (await import("./info-WQIK5ELT.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-MCLRNJ72.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-TBMYGOSP.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LVGGWN6X.js.map
