import { Signature, Commitment, SendTransactionApi, CompilableTransactionMessage, FullySignedTransaction, TransactionWithBlockhashLifetime, BaseTransactionMessage, TransactionMessageWithFeePayer, Rpc, GetEpochInfoApi, GetSignatureStatusesApi, GetLatestBlockhashApi, RpcSubscriptions, SignatureNotificationsApi, SlotNotificationsApi, Transaction, SimulateTransactionApi, MainnetUrl, DevnetUrl, TestnetUrl, createSolanaRpc, createSolanaRpcSubscriptions, RpcFromTransport, SolanaRpcApiFromTransport, RpcTransportFromClusterUrl, SolanaRpcSubscriptionsApi, Address, TransactionSigner, TransactionVersion, TransactionMessageWithFeePayerSigner, TransactionMessageWithBlockhashLifetime, ITransactionMessageWithFeePayer, TransactionMessage, KeyPairSigner, Base64EncodedWireTransaction, GetSignaturesForAddressApi } from '@solana/kit';
 ...
 */
declare function createTransaction<TVersion extends TransactionVersion, TFeePayer extends TransactionSigner>(props: CreateTransactionInput<TVersion, TFeePayer>): FullTransaction<TVersion, TransactionMessageWithFeePayerSigner>;
declare function createTransaction<TVersion extends TransactionVersion, TFeePayer extends Address>(props: CreateTransactionInput<TVersion, TFeePayer>): FullTransaction<TVersion, TransactionMessageWithFeePayer>;
